...
`dotspacemacs/user-config' first."
  (setq
   ...
   ;; disable warning on missing semicolons in javascript
   js2-strict-missing-semi-warning nil

   ;; set all the javascript/css indents to 2-spaces
   js2-basic-offset 2
   js-indent-level 2
